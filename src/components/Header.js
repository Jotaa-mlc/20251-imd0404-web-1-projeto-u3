...
function logedIn(user) {
    return (
        <>  
            <a href="/profile" className="user-profile-link" style={{ alignItems: 'center', display: 'flex'}}>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="my-products">Meus Produtos</a></li>
    ...
    return (
        <header>
            ...
            <div className="left-container">
                ...
                <a href="../paginas/cart-page.html" id="cartIconLink" alt="Carrinho" className="cart-icon" style={{ textDecoration: 'none', color: 'white' }}>
                    <svg fill="white" viewBox="0 0 24 24" width="28" height="28" xmlns="http://www.w3.org/2000/svg">
