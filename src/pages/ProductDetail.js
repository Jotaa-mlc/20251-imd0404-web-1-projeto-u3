...
function ProductDetail() {
    ...
    if (loading) return <div id="home-loading"><h4>Carregando...</h4><div className="loading-spinner"></div></div>;
        ...
        <div id="product-page">
            <div className="anuncio">
                <div className="info">
                    ...
                    <hr/>
                    <h2>Detalhes</h2>
                    <div className="detalhes d-flex"><div className='d-flex flex-column'><p><strong>Categoria</strong></p><span>{product.category}</span></div><div className='d-flex flex-column'><p><strong>Condição</strong></p><span>{product.condition}</span></div></div>
                    <hr/>
